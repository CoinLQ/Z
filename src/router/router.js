...
export const funeralRouter = [
    {
        path: '/longquan_funeral',
        icon: 'ios-list-outline',
        name: 'longquan_funeral',
        title: '龙泉大葬经',
        component: Main,
        children: [
            {
                ...
                icon: 'ios-paper',
                component: resolve => {
                    require(['@/views/funeral/longquan/details.vue'], resolve);
                }
            },
        ]
    },
    {
        path: '/substantial_funeral',
        icon: 'ios-list-outline',
        name: 'substantial_funeral',
        title: '实体葬经',
        component: Main,
        children: [
            {
                ...
                name: 'list',
                icon: 'ios-paper',
                component: resolve => { require(['@/views/funeral/substantial/list.vue'], resolve); }
            },
            {
                path: 'sub_details',
                access: 0,
                ...
                name: 'sub_details',
                icon: 'ios-paper',
                component: resolve => { require(['@/views/funeral/substantial/details.vue'], resolve); }
            },
        ]
    },
];
