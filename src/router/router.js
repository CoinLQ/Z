...
export const appRouter = [
        ...
        },
        {
            ...
            children: [
                ...
                { path: 'judge_difficult',  title: '校勘判取难字', name: 'judge_difficult-task', icon: 'ios-paper', component: resolve => { require(['@/views/collatetask/task_judge_difficult.vue'], resolve); } },
