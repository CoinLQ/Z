...
export const appRouter = [
        ...
        },
        {
            ...
            children: [
                ...
                { path: 'prepagetask', access: 0, title: '切分预处理', name: 'prepagetask-task', icon: 'images', component: resolve => { require(['@/views/common_tasks/task_prepagerect.vue'], resolve); } },
                { path: 'prepageverifytask', access: 0, title: '切分预处理审定', name: 'prepageverifytask-task', icon: 'images', component: resolve => { require(['@/views/common_tasks/task_prepagerectverify.vue'], resolve); } },
